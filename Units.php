    ...
    <div class="row">
      ...
      <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div
          ...
          <h4 class="h3"> Subjects Taught</h4>
                    ...
                    + Add Subject
                         ...
                         <?php
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                ...
                                $sql = "INSERT INTO subjects (subject_name,code)
                                VALUES ('$subject', '$code')";
        
                                    // Execute the query
                                    if ($result = mysqli_query($db, $sql)) {
                                    echo "<p style='color:green;font-size:30px'>Subject Added successful</p>";
                                    } else {
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add New Subject Taught</h5>
                    ...
                    <div class="modal-body">
                     <div class="container-fluid">
                        ...
                        <div class="row mb-1">
                            <label for="dob" class="col-md-12 col-form-label">Subject Name</label>
                            <div class="col-md-12">
                        ...
                        <div class="row mb-1">
                            <label for="dob" class="col-md-12 col-form-label">Code</label>
                            <div class="col-md-12">
