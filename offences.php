    ...
    <div class="row">
      ...
      <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div
          ...
          <h4 class="h3"> Offenses / Charges</h4>
          <div class="btn-toolbar mb-2 mb-md-0">
            <div class="py-2" style="display: flex;align-content: center;">
                ...
                <?php
                  if($role_id == 1){
                    echo ' <a href="Teachers/addoffence.php" class="btn btn-primary btn-md"> + New Offense </a>';
                  }
                  else{
        ...
        <div class="table-responsive pb-0">
                    <table class="table table-light table-sm table-striped">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th style="width:20%">Offense (charge)</th>
                                <th>Description</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <?php
                                $offesnsetype = new display();
                                $offesnsetype->DisplayOffenses();
                            ?>
